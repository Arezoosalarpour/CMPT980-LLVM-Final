...
Inputs: `inputs/`. Raw outputs: `raw/`. Commands: `commands.log`.
...
| `comparison.json` | Parsed metrics |
| `inputs/baseline.s` | MCA input (ELF `$238` form) |
| `inputs/baseline_equiv_17.s` | Equivalent `$17` form |
| `inputs/patched.s` | MCA input (patched) |
| `raw/*.txt` | Full llvm-mca stdout |
