...
Full sweep: `mca_sweep_table.md`, raw: `mca_sweep/`.
...
| Path | Description |
|------|-------------|
| `commands.log` | All commands |
| `mca_sweep_table.md` | Full n-sweep table |
| `mca_summary.json` | Crossover summary |
| `llvm_codegen/multi_shuffle.ll` | Four-shuffle reuse test IR |
| `llvm_codegen/multi_shuffle_patched.s` | 4× shuffle patched asm |
| `llvm_codegen/multi_shuffle_baseline.s` | 4× shuffle baseline asm |
| `inputs/` | MCA input assemblies |
