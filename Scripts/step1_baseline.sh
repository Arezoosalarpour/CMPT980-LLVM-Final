...
BASE="$PROJ/Results/generated/baseline"
LIT_PATCH="$PROJ/Patches/vector-shuffle-combining-avx2.ll.patch"
...
echo "Wrote unpatched lit-module asm: Results/generated/baseline/lit_x64_avx2.s" \
  | tee -a "$BASE/run.log"
...
echo "Done. See Results/generated/baseline/ (includes lit_x64_avx2.s for Step 3C)."
