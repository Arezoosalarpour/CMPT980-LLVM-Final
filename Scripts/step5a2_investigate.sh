...
OUT="$ROOT/Results/generated/step5a2"
...
python3 "$ROOT/Scripts/step5a2_search.py" "$ROOT" "$LLC" "$MCA" | tee -a "$OUT/commands.log"
python3 "$ROOT/Scripts/step5a2_report.py" "$OUT"
