...
#
# Prerequisites:
#   1. ./Scripts/step1_baseline.sh   → Results/generated/baseline/lit_x64_avx2.s
#   2. Canonical patches applied to the patched LLVM tree; tools rebuilt
#   3. export LLVM_PATCHED_LLC LLVM_FILECHECK
#
# Does NOT overwrite Patches/X86ISelLowering.patch
# Does not depend on the discarded Step 3A or Step 3B artifacts.
...
That script writes Results/generated/baseline/lit_x64_avx2.s.
